...
# --------------------- Full Model ---------------------
class DASNet1_CBAM_V1(nn.Module):
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        # ----- CBAM: 放在 concat 後、conv 前 -----
        self.cbam1 = CBAM(256 + 1024)  # 1280
        self.cbam2 = CBAM(256 + 1024)  # 1280
        self.cbam3 = CBAM(128 + 512)   # 640
        self.cbam4 = CBAM(64 + 256)    # 320
    ...
    def forward(self, x):
        ...
        # ----- Decoder V1: Concat -> CBAM -> Conv -> Upsample -----
...
if __name__ == '__main__':
    net = DASNet1_CBAM_V1(num_classes=2)
