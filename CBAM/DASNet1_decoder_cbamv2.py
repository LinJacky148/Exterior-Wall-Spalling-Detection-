...
# --------------------- Full Model ---------------------
class DASNet1_CBAM_V2(nn.Module):
    ...
    def forward(self, x):
        ...
        # ----- Decoder V2: Concat -> Conv -> CBAM -> Upsample -----
        x = torch.cat([x_aspp, skips[-1]], dim=1)
...
if __name__ == '__main__':
    net = DASNet1_CBAM_V2(num_classes=2)
